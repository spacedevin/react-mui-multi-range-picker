...
} = require("@spacedevin/react-mui-multi-range-picker");
const {
  MultiRangeDatePicker: ProPicker,
} = require("@spacedevin/react-mui-pro-multi-range-picker");
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "CJS Demo - Using CommonJS from NPM",
          ),
        ),
        React.createElement(
          ToggleButtonGroup,
          ...
          freeRanges.length > 0 &&
            React.createElement(
              ...
              React.createElement(
                ...
                `Selected Ranges (${freeRanges.length}):`,
              ),
              ...
              freeDates.length > 0 &&
                React.createElement(
                  ...
                  React.createElement(
                    Typography,
                    { variant: "subtitle2", gutterBottom: true },
                    `Total Selected Days: ${freeDates.length}`,
                  ),
                  React.createElement(
                    Typography,
                    {
          ...
          proDates.length > 0 &&
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Typography,
                  { variant: "body2", color: "text.secondary", sx: { ml: 2 } },
